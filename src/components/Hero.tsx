export default function Hero(){
    ...
    return <div className="min-h-screen w-full pt-32  bg-[#ECC302]">
        ...
        <div className="w-full h-auto container mx-auto px-4 py-28  flex flex-col md:flex-row items-center justify-between space-y-4">
            ...
            <div className="md:w-1/2 w-full h-auto ">
                <div className="h-auto w-full  px-2 flex flex-col items-center justify-center ">
                    <h1 className="mt-2 flex font-anton items-center justify-center text-4xl tracking-wider lg:text-6xl px-6 md:px-10 lg:18  flex-wrap leading-[120%] lg:leading-[140%] text-center space-y-10">AMERICA'S ONLY ROCK 'N' ROLL MAGAZINE</h1>
                    ...
                    <button className="mt-20 font-[900] font-serif text-lg md:text-2xl hover:bg-black hover:text-white border-[1px] border-white mt-100 bg-white text-black transition-all px-4 py-3">Subscribe</button>
                </div>
            </div>
        </div>
    </div>
